...
FILE * fptr1;
char fname1[100] = "NGODatabase.db"; //file which stores the NGO information
FILE * fptr2;
char fname2[100] = "AdminDatabase.db"; //file which stores the admin log in information
FILE * fptr3;
char fname3[100] = "UserDatabase.db"; //file which stores the user log in information
